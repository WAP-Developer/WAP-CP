...
<div class="kt-footer kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop">
    <div class="kt-footer__copyright">
        2019&nbsp;&copy;&nbsp;<a href="http://instagram.com/aldiwap" target="_blank" class="kt-link">WAP Developer</a>
    </div>
</div>
<!-- end:: Footer -->
...
<script src="<?= base_url('assets'); ?>/vendors/custom/components/vendors/bootstrap-datepicker/init.js" type="text/javascript"></script>
...
<script src="<?= base_url('assets'); ?>/vendors/custom/components/vendors/bootstrap-timepicker/init.js" type="text/javascript"></script>
...
<script src="<?= base_url('assets'); ?>/vendors/custom/components/vendors/bootstrap-switch/init.js" type="text/javascript"></script>
...
<script src="<?= base_url('assets'); ?>/vendors/custom/components/vendors/bootstrap-notify/init.js" type="text/javascript"></script>
