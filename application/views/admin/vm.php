                    ...
                    <form class="kt-form" action="<?= base_url('cp-admin/profile/vm'); ?>" method="post" enctype="multipart/form-data">
                        <div class="kt-portlet__body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="visi" class="form-control" id="editor" data-provide="markdown" rows="10" required><?= $getVM['visi'] ?></textarea>
                            </div>
                        </div>
                    ...
                    <form class="kt-form" action="<?= base_url('cp-admin/profile/vm'); ?>" method="post" enctype="multipart/form-data">
                        <div class="kt-portlet__body">
                            ...
                            <div class="form-group">
                                <label>Misi</label>
                                <input type="hidden" name="<?= $name; ?>" value="<?= $hash; ?>" />
                                <textarea name="misi" class="form-control" id="editor" data-provide="markdown" rows="10" required><?= $getVM['misi'] ?></textarea>
                            </div>
                        </div>
                        <div class="kt-portlet__foot">
                            <div class="kt-form__actions text-right">
