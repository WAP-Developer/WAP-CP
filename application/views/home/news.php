...
<div class="container">
                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="crop-recent">
                                    <img src="<?= base_url('assets/img/news/' . $getAll['photo']); ?>" alt="" class="img-recent">
                                </div>
                            </div>
                            <div class="col-9">
                                <div class="row mt-3 ml-2 mb-3">
                                    <a href="<?= base_url('news/detail/' . $getAll['slug']) ?>" class="title-litle-news">
                                        <?= $getAll['title']; ?>
                                    </a>
                                </div>
                            </div>
                ...
                <?php foreach ($getFourNews as $getFour) { ?>
                    <div class="box-vertical-news" data-aos="fade-left">
                        <div class="row">
                            <div class="col-5">
                                <div class="crop-four">
                                    <img src="<?= base_url('assets/img/news/' . $getFour['photo']); ?>" alt="" class="img-four">
                                </div>
                            </div>
            ...
            <div class="desktop">
                <div class="row mt-5" data-aos="fade-up">
                    <div class="col-6 desktop">
                        <div class="row justify-content-end mr-4">
                            <div class="big-news-cover">
                                <img src="<?= base_url('assets/img/news/' . $getTwo['photo']); ?>" alt="" class="big-news">
                            </div>
                        </div>
                    </div>
                    <div class="col-5 desktop">
                        ...
                        <div class="row">
                            <div class="tanggal-berita">
                                <i class="fas fa-calendar-alt"></i> <?= date('d F Y', strtotime($getTwo['update_at'])) ?>
                            </div>
                        </div>
                        <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-12 desktop">
            <div class="row justify-content-center pt-4 pb-3">
                <a href="<?= base_url('news/all'); ?>" class="btn btn-sm btn-success">Lihat Lebih Lengkap >></a>
            </div>
        </div>
    </div>
</div>
