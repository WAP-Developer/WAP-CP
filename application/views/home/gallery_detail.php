...
<div class="container pb-4">
    ...
    <div class="row <?php if (!$getAlbums) {
                        echo 'justify-content-center';
                    } ?> mt-3">
        <!-- Mobile -->
        <?php if (!$getDetailAlbums) { ?>
            <div class="mobile">
    ...
    <div class="row justify-content-center">
        <!-- Desktop -->
        <a href="<?= base_url('gallery'); ?>" class="btn btn-sm btn-success"><i class="fas fa-angle-double-left"></i> Kembali Ke Album </a>
        <!-- Desktop End -->
    </div>
