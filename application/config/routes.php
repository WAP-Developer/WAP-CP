...
$route['cp-admin/profile/edit-history/(:num)'] = 'admin/edit_history';
$route['cp-admin/profile/edit-achievement/(:num)'] = 'admin/edit_achievement/$1';
$route['cp-admin/profile/edit-group/(:num)'] = 'admin/edit_group/$1';
...
$route['cp-admin/job/all-recruitment'] = 'admin/all_recruitment';
$route['cp-admin/job/no-acc/(:num)'] = 'admin/no_acc/$1';
$route['cp-admin/job/acc/(:num)'] = 'admin/acc/$1';
...
$route['gallery/(:num)'] = 'landing/gallery/$1';
